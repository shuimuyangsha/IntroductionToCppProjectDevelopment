...
{
    //载入图片
    /* 0*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 静.png")));
    /* 1*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 右.png")));
    /* 2*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 右上.png")));
    /* 3*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 上.png")));
    /* 4*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 左上.png")));
    /* 5*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 左.png")));
    /* 6*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 左下.png")));
    /* 7*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 下.png")));
    /* 8*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero 右下.png")));
    /* 9*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Fire Path.png")));
    /*10*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Left Fire 00.png")));
    /*11*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Left Fire 01.png")));
    /*12*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Left Fire 02.png")));
    /*13*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Left Fire 03.png")));
    /*14*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Left Fire 04.png")));
    /*15*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Right Fire 00.png")));
    /*16*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Right Fire 01.png")));
    /*17*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Right Fire 02.png")));
    /*18*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Right Fire 03.png")));
    /*19*/m_vImage.push_back(Image::FromFile(_T("res/Foton The Desktop Hero Right Fire 04.png")));
